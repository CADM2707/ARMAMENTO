...
<div class="content-wrapper">
    <div class="container">
        ...
        <section class="content-header" style=" background-color: white; border-bottom: 1px solid #B9B9B9;  box-shadow: 1px 1px 5px #999;">
            <h1><span><label class="gray"> <span class="fa fa-home"></span></label></span> Inicio</h1>            
        </section>        
        <!-- Main content -->
        <section class="content" style=" background-color: white;" >
            <div class="row text-center">
                <img src="dist/img/pa2.png" class="img-fluid" alt="Responsive image">  <br><br>
                <img src="dist/img/armamento.png" class="img-fluid" alt="Responsive image">                  
            </div>
            <br>
            <br>
            <br>
